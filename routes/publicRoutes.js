...
// — LGPD: versões correntes dos termos legais (frontend lê antes de cadastros).
load("/public/legal", "./public/publicLegal");
...
load("/webhooks/whatsapp", "./public/webhookWhatsapp");
