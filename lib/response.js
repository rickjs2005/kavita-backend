...
// ---------------------------------------------------------------------------
// Legacy aliases kept for backward compatibility with code that imports the
// previous names (sendSuccess, sendCreated, sendPaginated).
// Do not use these names in new code.
// ---------------------------------------------------------------------------

/** @deprecated Use `ok()` */
const sendSuccess = ok;

/** @deprecated Use `created()` */
const sendCreated = created;

/** @deprecated Use `paginated()` */
